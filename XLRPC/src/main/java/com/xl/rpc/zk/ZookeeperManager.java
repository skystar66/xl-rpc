...
//
//    private String zookeeperAddress;// IP列表
//    private ZooKeeper zookeeper;
//
//    private String rootPath;
//
//    public ZookeeperManager(String zookeeperAddress, String rootPath) {
...
//        try {
//            zk = new ZooKeeper(zookeeperAddress, ZK_SESSION_TIMEOUT, new Watcher() {
//                @Override
